...
<head>
    ...
    <script style="text/javascript" src="jslib/highcharts-js/highcharts.js"></script>
    ...
    <script>
        /*   $(function(){
         ...
         title:node.text,
         closable:true,
         content: '<iframe src="' + url + '" iframeborder="0" style="border:0;width:100%;heigth:574px;"></iframe>'
         });
         }
         });
         });*/
